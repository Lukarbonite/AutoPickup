...
import com.natamus.treeharvester_common_forge.events.LeafEvents;
...
public class LeafEventsMixin {
    ...
    @WrapOperation(method = "onWorldTick",
            at = @At(value = "INVOKE", target = "Lcom/natamus/collective_common_forge/functions/BlockFunctions;dropBlock(Lnet/minecraft/world/level/Level;Lnet/minecraft/core/BlockPos;)V"),
            remap = false)
    ...
    @WrapOperation(method = "onWorldTick",
            at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/block/state/BlockState;randomTick(Lnet/minecraft/server/level/ServerLevel;Lnet/minecraft/core/BlockPos;Lnet/minecraft/util/RandomSource;)V"),
            remap = true)
    ...
    @WrapOperation(method = "onWorldTick",
            ...
            remap = true)
    private static void wrapTick(BlockState instance, ServerLevel world, BlockPos pos, RandomSource random, Operation<Void> original) {
        handle(world, pos, () -> original.call(instance, world, pos, random));
    }

    @WrapOperation(method = "onNeighbourNotify",
