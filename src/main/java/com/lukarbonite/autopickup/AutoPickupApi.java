...
public final class AutoPickupApi {
    ...
    public static void tryPickupExperience(PlayerEntity player, int experience) {
        ...
        Optional<RegistryEntry.Reference<Enchantment>> mendingEntryOptional = player.getWorld().getRegistryManager().getOrThrow(RegistryKeys.ENCHANTMENT).getEntry(Enchantments.MENDING.getValue());
