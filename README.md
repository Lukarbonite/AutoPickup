...
![Fabric](https://img.shields.io/badge/modloader-fabric-blue?style=for-the-badge)![Minecraft](https://img.shields.io/badge/minecraft-1.20.x-green?style=for-the-badge)![License](https://img.shields.io/badge/license-AGPL%203.0-lightgrey?style=for-the-badge)
...
*   **Traveler's Backpack:** Fully supported (1.20.1+1.21.0-10). If you have a backpack with the **Auto Pickup Upgrade**, items will be routed to your backpack filter first. If the backpack is full or the item isn't filtered, it falls back to your main inventory.
